"""Evaluation rubric strings used by GEval metrics."""

HELPFULNESS_CRITERIA = """## 1. Helpfulness
...
TONE_AND_APPROACH_CRITERIA = """**Core Philosophy:** A helpful response actively moves the user forward. It respects the user's time by removing cognitive load, breaking down institutional complexity, and charting a clear, actionable path toward their ultimate goal.
...
HONESTY_CRITERIA = """**Core Philosophy:** An honest response prioritizes absolute factual integrity and regulatory compliance over making a quick sale or providing a satisfying answer. It accurately reflects the boundaries of the insurance contract and cleanly communicates its own operational limits.
